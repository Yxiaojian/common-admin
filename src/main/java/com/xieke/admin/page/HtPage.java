...
public class HtPage<T> implements Serializable {
    ...
    public HtPage(long pageIndex, long pageSize, List<T> records, long total, long totalPage) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pageSize, pageIndex, records, total, totalPage);
    }
