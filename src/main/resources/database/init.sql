...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='系统日志表';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('29', '1', 'admin', 'com.xieke.admin.web.UserController.edit', '[User{, id=1, roleId=1, name=超级管理员, userName=null, passWord=null, salt=null, state=1, updateTime=null, createTime=null}]', '修改用户操作', '2018-12-06 17:19:35', '2018-12-06 17:19:35');
INSERT INTO `sys_log` VALUES ('30', '1', 'admin', 'com.xieke.admin.web.RoleController.save', '[Role{, id=2, permissionIds=,14,20,23,24,21,, available=1, roleName=测试员, roleCode=test, updateTime=null, createTime=null}]', '保存角色操作', '2018-12-06 17:46:36', '2018-12-06 17:46:36');
...
CREATE TABLE `sys_login_log` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='系统登录日志表';

-- ----------------------------
-- Records of sys_login_log
-- ----------------------------
INSERT INTO `sys_login_log` VALUES ('52', '1', 'admin', '127.0.0.1', 'XX XX 内网IP ', '2018-12-06 17:18:33', '2018-12-06 17:18:33');
INSERT INTO `sys_login_log` VALUES ('53', '1', 'admin', '127.0.0.1', 'XX XX 内网IP ', '2018-12-06 17:23:55', '2018-12-06 17:23:55');
INSERT INTO `sys_login_log` VALUES ('54', '1', 'admin', '127.0.0.1', 'XX XX 内网IP ', '2018-12-06 17:26:35', '2018-12-06 17:26:35');
...
INSERT INTO `sys_role` VALUES ('2', ',14,20,23,24,21,', '1', '测试员', 'test', '2018-12-06 17:46:36', '2018-07-10 11:19:49');
