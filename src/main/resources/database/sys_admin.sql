...
CREATE TABLE `sys_login_log`  (
  ...
  `create_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_login_log
-- ----------------------------
INSERT INTO `sys_login_log` VALUES (71, 1, 'admin', '127.0.0.1', NULL, '2019-08-04 16:17:23', '2019-08-04 16:17:23');
INSERT INTO `sys_login_log` VALUES (72, 1, 'admin', '0:0:0:0:0:0:0:1', NULL, '2019-08-05 21:05:41', '2019-08-05 21:05:41');
INSERT INTO `sys_login_log` VALUES (73, 1, 'admin', '0:0:0:0:0:0:0:1', NULL, '2019-08-24 17:20:46', '2019-08-24 17:20:46');
INSERT INTO `sys_login_log` VALUES (74, 1, 'admin', '0:0:0:0:0:0:0:1', NULL, '2019-08-24 22:36:08', '2019-08-24 22:36:08');
...
CREATE TABLE `sys_permission`  (
  ...
  `create_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统权限' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_classes`  (
  `FID` int(11) NOT NULL COMMENT '主键ID',
