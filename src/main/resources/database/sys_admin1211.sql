...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_log` VALUES ('125', '1', 'admin', 'com.xieke.admin.web.PermissionController.save', '{\"available\":1,\"parentId\":34,\"permissionCode\":\"changeclass:list\",\"permissionName\":\"转班\",\"resourceType\":\"button\",\"url\":\"\"}', '保存权限操作', '2019-12-04 13:52:00', '2019-12-04 13:52:00');
INSERT INTO `sys_log` VALUES ('126', '1', 'admin', 'com.xieke.admin.web.RoleController.save', '{\"available\":1,\"id\":1,\"permissionIds\":\",1,25,17,10,13,11,12,2,5,3,4,18,16,6,8,9,7,14,37,43,44,45,35,36,34,46,42,47,\",\"roleCode\":\"admin\",\"roleName\":\"超级管理员\"}', '保存角色操作', '2019-12-04 13:52:12', '2019-12-04 13:52:12');
INSERT INTO `sys_log` VALUES ('127', '1', 'admin', 'com.xieke.admin.web.RoleController.save', '{\"available\":1,\"id\":2,\"permissionIds\":\",14,37,43,44,45,35,36,34,46,42,47,\",\"roleCode\":\"teacher\",\"roleName\":\"主讲老师\"}', '保存角色操作', '2019-12-04 13:52:20', '2019-12-04 13:52:20');
...
CREATE TABLE `sys_login_log` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=218 DEFAULT CHARSET=utf8 COMMENT='登录日志';
...
INSERT INTO `sys_login_log` VALUES ('211', '1', 'admin', '127.0.0.1', null, '2019-11-29 15:23:50', '2019-11-29 15:23:50');
INSERT INTO `sys_login_log` VALUES ('212', '1', 'admin', '127.0.0.1', null, '2019-11-29 16:05:06', '2019-11-29 16:05:06');
INSERT INTO `sys_login_log` VALUES ('213', '1', 'admin', '127.0.0.1', null, '2019-11-29 16:38:34', '2019-11-29 16:38:34');
INSERT INTO `sys_login_log` VALUES ('214', '1', 'admin', '127.0.0.1', null, '2019-11-29 17:15:03', '2019-11-29 17:15:03');
INSERT INTO `sys_login_log` VALUES ('215', '1', 'admin', '127.0.0.1', null, '2019-12-04 13:32:59', '2019-12-04 13:32:59');
INSERT INTO `sys_login_log` VALUES ('216', '1', 'admin', '127.0.0.1', null, '2019-12-11 14:44:33', '2019-12-11 14:44:33');
INSERT INTO `sys_login_log` VALUES ('217', '1', 'admin', '127.0.0.1', null, '2019-12-11 18:30:09', '2019-12-11 18:30:09');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', ',1,25,17,10,13,11,12,2,5,3,4,18,16,6,8,9,7,14,37,43,44,45,35,36,34,46,42,47,', '1', '超级管理员', 'admin', '2019-12-04 13:52:12', '2018-07-10 11:19:49');
...
CREATE TABLE `t_order` (
  ...
  `FOrderType` int(11) DEFAULT NULL COMMENT '订单类型',
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES ('14', '20', '111111111', '0', '11111111', '', '', '', '5', '444', '10', '主讲老师test', '13', 'test2', '0', '0', '4', '课程英语', '0', '1', '2019', '0', '12', '3333.00', '1111.00', '金额3333 优惠1111 预缴222 欠费2000', '2222.00', '2022.00', '0', '0', '1', '超级管理员', '2019-11-27 19:44:43', '', '');
INSERT INTO `t_order` VALUES ('15', '21', '颜浩健', '0', '18258289618', '', '', '', '8', 'yhj', '9', '主讲老师test', '16', '士大夫给', '1', '4', '6', '承测', '1', '1', '2019', '0', '50', '50000.00', '20000.00', '金额50000  优惠20000 预缴16000 欠费14000', '30000.00', '16000.00', '0', '0', '1', '超级管理员', '2019-11-28 20:22:16', '', '');
INSERT INTO `t_order` VALUES ('16', '22', '测试', '0', '123123', '', '', '', '8', 'yhj', '9', '主讲老师test', '16', '士大夫给', '1', '4', '6', '承测', '1', '1', '2019', '0', '50', '50000.00', '11111.00', '3333', '38889.00', '42222.00', '0', '0', '1', '超级管理员', '2019-11-29 16:56:22', '', '');
...
INSERT INTO `t_pay_record` VALUES ('17', '16', null, '22222.00', '阿萨', '2019-11-29 16:56:22', '', '0');
INSERT INTO `t_pay_record` VALUES ('18', '16', '0', '10000.00', 'gf', '2019-11-29 16:59:52', '', '0');
INSERT INTO `t_pay_record` VALUES ('19', '16', '0', '10000.00', '方法', '2019-11-29 17:20:18', '', '0');
...
INSERT INTO `t_student` VALUES ('22', '测试', '0', '123123', '', '', '', '123123123123123', '1', null, '0', '2019-11-29 16:25:15', '', '', '');
INSERT INTO `t_student` VALUES ('23', '测试', '0', '12314234234', '', '', '', '23123123123', '1', null, '0', '2019-11-29 16:28:13', '', '', '');
